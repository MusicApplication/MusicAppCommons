...
import com.musicplayer.commons.dialogs.ConfirmationAdvancedDialog
import com.musicplayer.commons.dialogs.ConfirmationDialog
import com.musicplayer.commons.dialogs.RateStarsDialog
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupFacebook() {
        about_facebook.setOnClickListener {
            var link = "https://www.facebook.com/musicplayer"
            try {
    ...
    private fun setupReddit() {
        about_reddit.setOnClickListener {
            launchViewIntent("https://www.reddit.com/r/musicplayer")
        }
    }
