package com.musicplayer.commons.activities
...
import com.musicplayer.commons.asynctasks.CopyMoveTask
import com.musicplayer.commons.dialogs.ConfirmationDialog
import com.musicplayer.commons.dialogs.ExportSettingsDialog
import com.musicplayer.commons.dialogs.FileConflictDialog
import com.musicplayer.commons.dialogs.WritePermissionDialog
import com.musicplayer.commons.extensions.*
import com.musicplayer.commons.helpers.*
import com.musicplayer.commons.interfaces.CopyMoveListener
import com.musicplayer.commons.models.FAQItem
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.musicplayer")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.musicplayer.")
