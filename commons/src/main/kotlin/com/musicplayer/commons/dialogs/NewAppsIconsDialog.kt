...
import com.musicplayer.commons.extensions.launchViewIntent
...
class NewAppsIconsDialog(val activity: Activity) {
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_new_apps_icons, null).apply {
            val dialerUrl = "https://play.google.com/store/apps/details?id=com.musicplayer.dialer"
            val smsMessengerUrl = "https://play.google.com/store/apps/details?id=com.musicplayer.smsmessenger"
            val voiceRecorderUrl = "https://play.google.com/store/apps/details?id=com.musicplayer.voicerecorder"
