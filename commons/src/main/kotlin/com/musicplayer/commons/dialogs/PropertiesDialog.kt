...
import com.musicplayer.commons.helpers.isNougatPlus
import com.musicplayer.commons.helpers.sumByInt
import com.musicplayer.commons.helpers.sumByLong
...
class PropertiesDialog() {
    ...
    constructor(activity: Activity, path: String, countHiddenItems: Boolean = false) : this() {
        ...
        if (fileDirItem.isDirectory) {
            ...
            if (activity.baseConfig.appId.removeSuffix(".debug") == "com.musicplayer.filemanager.pro") {
