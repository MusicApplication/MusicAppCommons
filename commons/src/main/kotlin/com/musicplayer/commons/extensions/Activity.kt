...
import com.musicplayer.commons.dialogs.*
import com.musicplayer.commons.helpers.*
import com.musicplayer.commons.models.*
...
fun Activity.launchPurchaseThankYouIntent() {
    try {
        launchViewIntent("market://details?id=com.musicplayer.thankyou")
...
fun Activity.openPathIntent(path: String, forceChooser: Boolean, applicationId: String, forceMimeType: String = "", extras: HashMap<String, Boolean> = HashMap()) {
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.musicplayer.gallery.pro" || applicationId == "com.musicplayer.gallery.pro.debug") {
