package com.musicplayer.commons.extensions
...
import com.musicplayer.commons.R
import com.musicplayer.commons.helpers.*
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_ACCENT_COLOR
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.musicplayer.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.musicplayer.commons.models.AlarmSound
import com.musicplayer.commons.models.BlockedNumber
import com.musicplayer.commons.models.SharedTheme
import com.musicplayer.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.musicplayer.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.musicplayer.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.musicplayer.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.musicplayer."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.musicplayer.contacts") && !packageName.startsWith("com.musicplayer.dialer")) {
        true
    } else if ((packageName.startsWith("com.musicplayer.contacts") || packageName.startsWith("com.musicplayer.dialer")) && isQPlus()) {
