package com.musicplayer.commons.helpers
...
import com.musicplayer.commons.extensions.getIntValue
import com.musicplayer.commons.extensions.getStringValue
import com.musicplayer.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.musicplayer.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.musicplayer.dialer" && packageName != "com.musicplayer.smsmessenger" && packageName != "com.musicplayer.calendar.pro") {
                return contacts
            }
